...
Route::group(['middleware' => ['role:Warehouse']], function () {
    ...
    Route::prefix('warehouse')->group(function(){
        ...
        Route::controller(WarehouseTransactionController::class)->group(function(){
            ...
            Route::get('/transaction/{id}/show', 'show')->name('warehouse.transaction.show');
            Route::put('/transaction/{id}/update', 'update')->name('warehouse.transaction.update');
        });
...
Route::group(['middleware' => ['role:Cashier']], function () {
    ...
    Route::prefix('cashier')->group(function(){
        ...
        Route::controller(CashierTransactionController::class)->group(function(){
